<template>
        ...
        <h4>{{ $t('sortby.sort_problems_by') }}</h4>
        <div class="flex flex-wrap">
            <chip :togglable="false" v-for="sort in sorts" :key="sort"  :checked="(sort == activeSort)" @click="onChangeSort(sort)" :text="$t(`sortby.`+sort)"></chip>
        </div>
