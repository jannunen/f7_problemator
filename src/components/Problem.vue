...
<template>
  ...
  <show-public-ascents :problem="problem" :opened="showPublicAscentsDialog" @close="showPublicAscentsDialog=false" :ascents="problem.public_ascents"> </show-public-ascents>
    <div class="m-0 p-0">
